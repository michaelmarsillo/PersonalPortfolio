            ...
            <div className="pl-4 sm:pl-8 flex items-start relative hover:translate-x-1 transition-transform duration-300">
              <div className="flex items-baseline space-x-2">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <span className="absolute inset-0 theme-pill opacity-100 transition-opacity duration-300 group-hover:opacity-90"></span>
                  <span className="relative flex items-center gap-1.5 theme-accent-strong transition-all duration-300 group-hover:translate-x-0.5">
                    see my resume
